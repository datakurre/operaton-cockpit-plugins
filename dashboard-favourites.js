...
var StarButton = function (_a) {
    ...
    return (React.createElement("button", { type: "button", className: "btn btn-default btn-sm", onClick: handleToggle, "aria-label": isFav ? 'Remove from favourites' : 'Add to favourites', title: isFav ? 'Remove from favourites' : 'Add to favourites', style: {
            width: '40px',
            height: '34px',
            marginTop: '5px',
            padding: '4px 6px',
        ...
        React.createElement("span", { className: isFav ? 'glyphicon glyphicon-star' : 'glyphicon glyphicon-star-empty', "aria-hidden": "true", style: { fontSize: '16px' } })));
};
/**
                ...
                Cell: function (_a) {
                    ...
                    if (incidents > 0) {
                        return (React.createElement("div", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center' } },
                            React.createElement("span", { className: "glyphicon glyphicon-remove-circle", style: { color: '#d9534f', fontSize: '20px' }, "aria-label": "Has incidents", title: "".concat(incidents, " incident").concat(incidents !== 1 ? 's' : '') })));
                    }
                    return (React.createElement("div", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center' } },
