...
var UnlockDialog = function (_a) {
    ...
    var _f = reactExports.useState(false), unlocking = _f[0], setUnlocking = _f[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    console.error('Error fetching locked tasks:', err_1);
                    return [3 /*break*/, 5];
                case 4:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    var handleToggleAll = function () {
        if (selectedTasks.size === lockedTasks.length) {
            ...
            setSelectedTasks(new Set(lockedTasks.map(function (t) { return t.id; })));
        }
    };
    var handleUnlock = function () { return __awaiter(void 0, void 0, void 0, function () {
        var unlockPromises, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    ...
                    console.error('Error unlocking tasks:', err_2);
                    return [3 /*break*/, 6];
                case 5:
                    setUnlocking(false);
                    return [7 /*endfinally*/];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", { className: "btn btn-default btn-toolbar", title: "Unlock External Tasks", onClick: handleOpen, style: {
                padding: '6px 9px',
                display: 'flex',
                alignItems: 'center',
            ...
            React.createElement(HiLockOpen, { style: { fontSize: '1.33em' } })),
        React.createElement(ReactModal, { className: "modal-dialog", isOpen: isOpen, onRequestClose: handleClose, style: {
                content: {},
                overlay: {
                    zIndex: 2000,
                },
            ...
            React.createElement("div", { className: "modal-content", style: {
                ...
                React.createElement("div", { className: "modal-header" },
                    React.createElement("h3", null, "Unlock External Tasks"),
                    React.createElement("button", { onClick: handleClose, className: "close", style: {
                            position: 'absolute',
                            right: '15px',
                            top: '15px',
                            border: 'none',
                ...
                React.createElement("div", { className: "modal-body", style: { flex: 1, overflow: 'auto' } },
                    error && (React.createElement("div", { className: "alert alert-danger", role: "alert" }, error)),
                    loading ? (React.createElement("div", { style: { textAlign: 'center', padding: '2em' } }, "Loading locked tasks...")) : lockedTasks.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: '2em', color: '#666' } }, "No locked external tasks found for this process instance.")) : (React.createElement(React.Fragment, null,
                        React.createElement("div", { style: { marginBottom: '1em' } },
                            React.createElement("label", { style: { display: 'flex', alignItems: 'center', cursor: 'pointer' } },
                                React.createElement("input", { type: "checkbox", checked: selectedTasks.size === lockedTasks.length && lockedTasks.length > 0, onChange: handleToggleAll, style: { marginRight: '0.5em' } }),
                                React.createElement("strong", null,
                                    "Select All (",
                                    lockedTasks.length,
                                    " tasks)"))),
                        React.createElement("div", { style: { border: '1px solid #ddd', borderRadius: '4px' } }, lockedTasks.map(function (task, index) { return (React.createElement("div", { key: task.id, style: {
                                padding: '0.75em',
                            ...
                            React.createElement("label", { style: {
                                ...
                                React.createElement("input", { type: "checkbox", checked: selectedTasks.has(task.id), onChange: function () { return handleToggleTask(task.id); }, style: { marginRight: '0.5em', marginTop: '0.2em' } }),
                                React.createElement("div", { style: { flex: 1 } },
                                    React.createElement("div", { style: { fontWeight: 'bold', marginBottom: '0.25em' } }, task.topicName),
                                    React.createElement("div", { style: { fontSize: '0.9em', color: '#666' } },
                                        ...
                                        task.errorMessage && (React.createElement("div", { style: { color: '#d9534f', marginTop: '0.25em' } },
                                            "Error: ",
                                            task.errorMessage))))))); }))))),
                React.createElement("div", { className: "modal-footer", style: {
                        padding: '1em',
                        display: 'flex',
                        alignItems: 'center',
                    ...
                    React.createElement("button", { onClick: handleClose, className: "btn btn-default", disabled: unlocking }, "Close"),
                    React.createElement("button", { onClick: handleUnlock, className: "btn btn-primary", disabled: selectedTasks.size === 0 || unlocking }, unlocking ? 'Unlocking...' : "Unlock ".concat(selectedTasks.size, " task").concat(selectedTasks.size !== 1 ? 's' : '')))))));
};
