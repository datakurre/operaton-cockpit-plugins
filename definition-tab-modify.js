...
var BatchSignalForm = function (_a) {
    ...
    var onSubmit = function (data) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    setSuccessMessage("Signal \"".concat(data.signalName, "\" broadcast successfully! All matching signal catch events have been triggered."));
                    return [3 /*break*/, 4];
                case 2:
                    err_2 = _a.sent();
    ...
    return (React.createElement(FormProvider, __assign({}, methods),
        React.createElement("form", { onSubmit: function (e) {
            ...
            React.createElement("div", { className: "modify-form__header" },
                React.createElement("p", { className: "modify-form__description" }, "Broadcast a signal event. The signal will be delivered to all matching signal catch events across all process instances.")),
            React.createElement("div", { className: "modify-form__section" },
                React.createElement("div", { className: "modify-form__field" },
            ...
            React.createElement(VariableBuilder, { name: "processVariables", showLocalFlag: false }),
            React.createElement(WarningBox, null, "Signals are broadcast globally and will trigger all matching signal catch events across all process instances, not just this process definition. Use with caution in production environments."),
            error && React.createElement(ErrorMessage, { message: error }),
            successMessage && React.createElement(SuccessMessage, { message: successMessage }),
            React.createElement("div", { className: "modify-form__actions" },
